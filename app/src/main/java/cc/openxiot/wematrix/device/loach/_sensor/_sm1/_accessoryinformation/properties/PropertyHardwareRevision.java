package cc.openxiot.wematrix.device.loach._sensor._sm1._accessoryinformation.properties;
...
public class PropertyHardwareRevision extends PropertyController<String> {
    ...
    public static final String TYPE = "urn:homekit-spec:property:hardware-revision:00000053:loach:sm1:1";
