package cc.openxiot.matrix.device.loach._sprinkler._fff;

import cn.geekcity.xiot.support.codegen.vertx.typedef.controller.DeviceController;

import cc.openxiot.matrix.device.loach._sprinkler._fff._accessoryinformation.ServiceAccessoryInformation;
import cc.openxiot.matrix.device.loach._sprinkler._fff._irrigationsystem.ServiceIrrigationSystem;
