...
import cc.openxiot.wematrix.appLanguage
import cc.openxiot.wematrix.ui.profile.filterLanguages
...
class AppLanguagesTest {
    ...
    fun `自称与英文名都不重复`() {
        ...
        for (field in listOf("自称" to { l: cc.openxiot.wematrix.AppLanguage -> l.endonym },
                             "英文名" to { l: cc.openxiot.wematrix.AppLanguage -> l.englishName })) {
