package cc.openxiot.wematrix.device.loach._sensor._s1;

import cn.geekcity.xiot.support.codegen.vertx.typedef.controller.DeviceController;

import cc.openxiot.wematrix.device.loach._sensor._s1._accessoryinformation.ServiceAccessoryInformation;
import cc.openxiot.wematrix.device.loach._sensor._s1._temperaturesensor.ServiceTemperatureSensor;
import cc.openxiot.wematrix.device.loach._sensor._s1._humiditysensor.ServiceHumiditySensor;
