package cc.openxiot.matrix.device.loach._airconditioner._g1._heatercooler;

import cc.openxiot.matrix.device.loach._airconditioner._g1._heatercooler.properties.PropertyHeatingThresholdTemperature;
import cc.openxiot.matrix.device.loach._airconditioner._g1._heatercooler.properties.PropertyRotationSpeed;
import cc.openxiot.matrix.device.loach._airconditioner._g1._heatercooler.properties.PropertyActive;
import cc.openxiot.matrix.device.loach._airconditioner._g1._heatercooler.properties.PropertyCurrentHeaterCoolerState;
import cc.openxiot.matrix.device.loach._airconditioner._g1._heatercooler.properties.PropertyTargetHeaterCoolerState;
import cc.openxiot.matrix.device.loach._airconditioner._g1._heatercooler.properties.PropertyCurrentTemperature;
import cc.openxiot.matrix.device.loach._airconditioner._g1._heatercooler.properties.PropertyCoolingThresholdTemperature;
