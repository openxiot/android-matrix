package cc.openxiot.wematrix.device.loach._sensor._l1._accessoryinformation;

import cc.openxiot.wematrix.device.loach._sensor._l1._accessoryinformation.properties.PropertyFirmwareRevision;
import cc.openxiot.wematrix.device.loach._sensor._l1._accessoryinformation.properties.PropertyIdentify;
import cc.openxiot.wematrix.device.loach._sensor._l1._accessoryinformation.properties.PropertyManufacturer;
import cc.openxiot.wematrix.device.loach._sensor._l1._accessoryinformation.properties.PropertyModel;
import cc.openxiot.wematrix.device.loach._sensor._l1._accessoryinformation.properties.PropertyName;
import cc.openxiot.wematrix.device.loach._sensor._l1._accessoryinformation.properties.PropertySerialNumber;
import cc.openxiot.wematrix.device.loach._sensor._l1._accessoryinformation.properties.PropertyAccessoryFlags;
import cc.openxiot.wematrix.device.loach._sensor._l1._accessoryinformation.properties.PropertyHardwareRevision;
...
public class ServiceAccessoryInformation extends ServiceController {
    ...
    public static final String TYPE = "urn:homekit-spec:service:accessory-information:0000003e:loach:l1:1";
