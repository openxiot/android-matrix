package cc.openxiot.matrix.device.loach._sensor._sm1;

import cn.geekcity.xiot.support.codegen.vertx.typedef.controller.DeviceController;

import cc.openxiot.matrix.device.loach._sensor._sm1._accessoryinformation.ServiceAccessoryInformation;
import cc.openxiot.matrix.device.loach._sensor._sm1._smokesensor.ServiceSmokeSensor;
