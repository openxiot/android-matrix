package cc.openxiot.matrix.device.loach._sprinkler._fff._accessoryinformation;

import cc.openxiot.matrix.device.loach._sprinkler._fff._accessoryinformation.properties.PropertyFirmwareRevision;
import cc.openxiot.matrix.device.loach._sprinkler._fff._accessoryinformation.properties.PropertyIdentify;
import cc.openxiot.matrix.device.loach._sprinkler._fff._accessoryinformation.properties.PropertyManufacturer;
import cc.openxiot.matrix.device.loach._sprinkler._fff._accessoryinformation.properties.PropertyModel;
import cc.openxiot.matrix.device.loach._sprinkler._fff._accessoryinformation.properties.PropertyName;
import cc.openxiot.matrix.device.loach._sprinkler._fff._accessoryinformation.properties.PropertySerialNumber;
import cc.openxiot.matrix.device.loach._sprinkler._fff._accessoryinformation.properties.PropertyAccessoryFlags;
import cc.openxiot.matrix.device.loach._sprinkler._fff._accessoryinformation.properties.PropertyHardwareRevision;
