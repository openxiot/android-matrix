package cc.openxiot.wematrix.device.loach._sprinkler._fff._accessoryinformation.properties;
...
public class PropertyFirmwareRevision extends PropertyController<String> {
    ...
    public static final String TYPE = "urn:homekit-spec:property:firmware-revision:00000052:loach:fff:1";
