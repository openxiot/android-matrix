package cc.openxiot.matrix.device.loach._sensor._co2._accessoryinformation.properties;
...
public class PropertyFirmwareRevision extends PropertyController<String> {
    ...
    public static final String TYPE = "urn:homekit-spec:property:firmware-revision:00000052:loach:co2:1";
