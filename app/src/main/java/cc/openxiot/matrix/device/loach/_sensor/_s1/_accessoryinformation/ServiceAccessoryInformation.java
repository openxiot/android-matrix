package cc.openxiot.matrix.device.loach._sensor._s1._accessoryinformation;

import cc.openxiot.matrix.device.loach._sensor._s1._accessoryinformation.properties.PropertyFirmwareRevision;
import cc.openxiot.matrix.device.loach._sensor._s1._accessoryinformation.properties.PropertyIdentify;
import cc.openxiot.matrix.device.loach._sensor._s1._accessoryinformation.properties.PropertyManufacturer;
import cc.openxiot.matrix.device.loach._sensor._s1._accessoryinformation.properties.PropertyModel;
import cc.openxiot.matrix.device.loach._sensor._s1._accessoryinformation.properties.PropertyName;
import cc.openxiot.matrix.device.loach._sensor._s1._accessoryinformation.properties.PropertySerialNumber;
import cc.openxiot.matrix.device.loach._sensor._s1._accessoryinformation.properties.PropertyAccessoryFlags;
import cc.openxiot.matrix.device.loach._sensor._s1._accessoryinformation.properties.PropertyHardwareRevision;
